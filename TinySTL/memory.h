...
// 这个头文件负责更高级的动态内存管理
// 包含一些基本函数、空间配置器、未初始化的储存空间管理，以及一个类模板 auto_ptr

#include <cstddef>
#include <cstdlib>
#include <climits>

#include "algobase.h"  // 包含算法相关的函数
#include "allocator.h"  // 包含空间配置器相关的函数
#include "construct.h"  // 包含构造和析构相关的函数
#include "uninitialized.h"  // 包含未初始化的储存空间管理相关的函数
